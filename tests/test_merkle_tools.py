...
def test_make_tree():
    ...
    mt.add_leaf(["bitcoin", "blockchain"], do_hash=True)
    mt.make_tree()
    assert mt.merkle_root == '765f15d171871b00034ee55e48ffdf76afbc44ed0bcff5c82f31351d333c2ed1'
...
def test_one_leaf():
    ...
    mt.make_tree()
    assert mt.merkle_root == 'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb'
...
def test_5_leaves():
    ...
    mt.make_tree()
    assert mt.merkle_root == 'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba'
